...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    arbitrum: {
      url: `https://arbitrum.infura.io/v3/${providerApiKey}`,
      accounts: [deployerPrivateKey],
    },
    arbitrumSepolia: {
    ...
    espressoLocal: {
      url: "http://0.0.0.0:8547", // Replace with the actual Espresso Rollup RPC URL
      chainId: 13131313, // Replace with the correct chain ID for Espresso
      accounts: [deployerPrivateKey],
    },
  },
